...
url: https://johnastewart.org/tools/airtable-review/
archive_url: https://web.archive.org/web/20240521130204/https://johnastewart.org/tools/airtable-review/
published: '2018-05-18T20:30:25+00:00'
modified: '2018-05-18T20:30:25+00:00'
category: Tools
tags:
- Office of Digital Learning
- Project Management
- University of Oklahoma
excerpt: I have been trying out different project management tools over the last few weeks.
  So far, I’ve used Notion, Trello, and AirTable and also looked at half a dozen others. I
  also tried a notebo…
featured_image:
  url: https://johnastewart.org/wp-content/uploads/2018/05/Screen-Shot-2018-05-18-at-2.00.52-PM-1024x718.png
  alt: ''
embeds:
- type: iframe
  title: ''
  url: https://giphy.com/embed/3oEdv1EbS2Ss1NvrUc
  source_url: https://giphy.com/embed/3oEdv1EbS2Ss1NvrUc
- type: youtube
  title: OLC Live with John Stewart and Clark Shah-Nelson
  url: https://www.youtube.com/watch?v=wM6tP_cT3iw
  source_url: https://www.youtube.com/embed/wM6tP_cT3iw?feature=oembed
recovered_from:
  blog_capture: https://web.archive.org/web/20240810065157/https://johnastewart.org/blog/
  post_capture_timestamp: '20240810065157'
---

I have been trying out different project management tools over the last few weeks. So far, I’ve used [Notion](https://www.notion.so/), [Trello](https://trello.com/), and [AirTable](https://airtable.com/) and also looked at half a dozen others. I also tried a notebook and paper, but I definitely prefer the digital.

[via GIPHY](https://giphy.com/gifs/working-office-monkey-take-a-note-3oEdv1EbS2Ss1NvrUc)
...
The second goal is seeing if any of these tools also make sense for adoption by the Office of Digital Learning. We are in the process of [hiring new IDs, a new instructional technologist, and a new video person](http://www.ou.edu/digitallearning/join-the-team). We’ve been using a combination of Trello and excel to track things for a while, but in an OLC Live conversation with Clark Shah-Nelson, I realized that we could probably do better.

[OLC Live with John Stewart and Clark Shah-Nelson](https://www.youtube.com/watch?v=wM6tP_cT3iw)

## AirTable

This week I’ve been trying out AirTable at the recommendation of [Angela Gunder](https://twitter.com/adesinamedia). As the name suggests, AirTable is a lightweight tool for building tables. My guess is that many people are put off by tables due to repressed memories of having to look at MS Access in a poorly thought out computer class as a kid. I, however, love tables. Working with websites as much as I do, everything now looks like a table. Each webpage is a table. A website is just a table of webpages. And I manage big tables of all the OU Create websites. I’ve organized my research notes into [online tables](https://johnastewart.org/digital-projects/situating-chemistry/) and I’ve built [tables for history undergrads to do the same](https://johnastewart.org/consultations/digital-note-taking-in-the-history-classroom-part-2/).

For a couple of weeks, I was using [Notion.so](https://www.notion.so/), and I like how it lays everything out in linked webpages with embedded spreadsheets. Any record that you put into the system can become it’s own little wiki page with embeddable images, spreadsheets, and links to other pages.
...
So what I wanted, was something that combined Trello’s Kanban to-do charts with a broader table layout with multiple ways to drill down into the data. AirTable has Kanban charts taking care of my need for visual to-do lists: [!\[A screen shot AirTable's Kanban chart view\](https://i0.wp.com/johnastewart.org/wp-content/uploads/2018/05/Screen-Shot-2018-05-18-at-2.00.52-PM.png?resize=629%2C441&ssl=1)](https://i0.wp.com/johnastewart.org/wp-content/uploads/2018/05/Screen-Shot-2018-05-18-at-2.00.52-PM.png?ssl=1) When you update the status (or any other information) of a card in the chart, that update carries throughout the rest of the system. You can view all of your items in a set of spreadsheets that can be tied together with relational tables:

[!\[Screenshot of AirTable's table view\](https://i0.wp.com/johnastewart.org/wp-content/uploads/2018/05/Screen-Shot-2018-05-18-at-2.01.00-PM.png?resize=629%2C441&ssl=1)](https://i0.wp.com/johnastewart.org/wp-content/uploads/2018/05/Screen-Shot-2018-05-18-at-2.01.00-PM.png?ssl=1)
