---
title: Open Notes for Deep Maps
date: '2016-06-09T20:39:22+00:00'
slug: open-notes-for-deep-maps
tags:
- Crowdsourcing
- Digital Humanities
- Doing History
...
summary: For the last couple of years, I have been working with my colleague John
  Perkins on building a database called Situating Chemistry. With this database we
  have been collecting information about the …
originalUrl: https://johnastewart.org/dh/open-notes-for-deep-maps/
archiveUrl: https://web.archive.org/web/20231204034150/https://johnastewart.org/dh/open-notes-for-deep-maps/
lastmod: '2019-11-07T20:57:08+00:00'
cover:
  image: WorldMap2.png
  alt: ''
---

For the last couple of years, I have been working with my colleague John Perkins on building a database called [Situating Chemistry](http://Situatingchemistry.org). With this database we have been collecting information about the sites where chemistry was done in the 18th and 19th centuries, who was doing the chemistry, and what they were doing.

One of the primary visualizations of the database is [a map with a pin on each of the sites in the database](http://situatingchemistry.org/worldmap). When you click on a pin, you get some basic information about who owned the site, what street it was on (or town if we don’t know the street), the years of operation, and whether the site has been classified as industrial, academic, medical, courtly, mercantile, or one of several other options. Below is a screenshot showing the 650 or so sites that we have catalogued in Paris, overlaid onto a map of the city from 1790. As you zoom in on the city, the numbered pins break down until you can see each individual sites location.

[!\[A screen shot of the world map in the Situating Chemistry database featuring data about 18th century Paris\](SitChemScreenShot.png?resize=500%2C291&ssl=1)](SitChemScreenShot.png?ssl=1)

If you want to see more information you can click view and see an extended set of information about the given site. Here’s the record for the site highlighted in the map above: [Issy Farjas 1811 SIT](http://situatingchemistry.org/node/6192). From there you could find links for more information about the sites owner, [Jean Louis Farjas](http://situatingchemistry.org/node/6187), or links to other sites that produced [sulphuric acid](http://situatingchemistry.org/taxonomy/term/170), or more information about the primary sources ( [Oudiette 1817](http://situatingchemistry.org/node/6193) ) for the information.
...
[!\[Situating Chemistry World Map\](WorldMap2.png?resize=500%2C291&ssl=1)](WorldMap2.png?ssl=1)
...
There are at least a couple of challenges in convincing people to spend time entering data. The primary challenge seems to be that people would rather spend time reading and writing rather than doing data entry. I think we’re as unlikely to find historians who love data entry as we are to find unicorns. However, we hope that the ease of getting the pre-built map visualization and other forms of data visualization ( [timeline](http://situatingchemistry.org/timeline), [graphs](http://situatingchemistry.org/peoplecareercount), etc.) will be enough to entice people to use the system.
