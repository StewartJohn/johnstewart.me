---
title: Getting Started with WordPress in OU Create
date: '2018-09-05T17:59:16+00:00'
slug: getting-started-with-wordpress-in-ou-create
tags:
- Create
- WordPress
summary: It’s back to school season, and for me that means helping students and faculty
  set up websites. The Office of Digital Learning at the University of Oklahoma provides
  a service called OU Creat…
originalUrl: https://johnastewart.org/tools/getting-started-with-wordpress-in-ou-create/
archiveUrl: https://web.archive.org/web/20240718223215/https://johnastewart.org/tools/getting-started-with-wordpress-in-ou-create/
lastmod: '2020-01-27T15:28:41+00:00'
cover:
  image: Screen-Shot-2018-09-05-at-12.33.58-PM.png
  alt: ''
---
...
1. Sign up for an account in OU Create
2. Install WordPress—about 90% of our users have at least one WordPress site. The classes that are using custom HTML or SQL generally are starting with more coding experience.
3. Write a post and a page to get familiar with the editor(s)
4. Setup their website’s menu
5. Play with themes
6. Share a link to their site or a post

## OU Create

To sign up for an OU Create account, users go to create.ou.edu and click on the big blue “Get started” button

![screen shot of the OU Create landing page](Screen-Shot-2018-08-08-at-9.54.23-AM.png?resize=768%2C538&ssl=1)

_OU Create landing page_
...
![Screenshot of the AddOn Domain function in the cPanel for Reclaim Hosting](AddOnDomain.png?resize=768%2C450&ssl=1)

_OU Create Control Panel (cPanel)_
...
![](Screen-Shot-2018-09-05-at-11.55.17-AM.png?resize=768%2C548&ssl=1)

_WordPress settings configuration_

Users need to make sure they are installing WordPress in the desired domain. Click on the drop down arrow for the domains and **be sure to select the secured version of your domain (the one beginning with https://).**

The default settings will take care of code updates and backups for them, so the only other things they need to change are the administrative username and password and the site title. If a user forgets to change these settings, they can always access them again by clicking on ‘My Apps’ from their control panel and then editing the settings of this or any other app.
...
One of the keys to getting WordPress to look good is including ‘Featured Images’ in your posts and pages. You can add a featured image in the post settings on the right side of the screen as you’re adding a new post. These are the big images that would show up at the top of a post and might represent the post in social media. In this theme, called [Garfunkel by Anders Noren](http://www.andersnoren.se/teman/garfunkel-wordpress-theme/), the featured image shows up in the home page preview for each post. Most themes are built around the featured images.

![](Screen-Shot-2018-09-05-at-12.33.58-PM.png?resize=1170%2C748&ssl=1)

_Garfunkel WP theme by Anders Noren_
...
[The Ultimate WordPress Menu Tutorial (2021)](https://www.youtube.com/watch?v=ERpr0TCnf4w)
