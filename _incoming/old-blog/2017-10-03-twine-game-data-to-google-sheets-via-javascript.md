...
url: https://johnastewart.org/coding/twine-game-data-to-google-sheets-via-javascript/
archive_url: https://web.archive.org/web/20240718235940/https://johnastewart.org/coding/twine-game-data-to-google-sheets-via-javascript/
published: '2017-10-03T20:50:25+00:00'
modified: '2018-05-14T03:09:26+00:00'
category: Coding
tags:
- Game-based Learning
- GitHub
- Google App Scripts
- Twine
excerpt: Using Twine, a free, open-source, text-based game software, you can build choose
  your own adventure games that explore the untaken paths in literature, promote empathy through
  simulated experiences…
featured_image:
  url: https://johnastewart.org/wp-content/uploads/2017/10/Screen-Shot-2017-10-03-at-1.16.42-PM-1024x662.png
  alt: ''
embeds: []
recovered_from:
...
## Twine Game Code (see [newer version](https://johnastewart.org/coding/twine-game-data-to-google-sheets-via-javascript-version-2/) )

*I’ve posted an [updated version of this blog post](https://johnastewart.org/coding/twine-game-data-to-google-sheets-via-javascript-version-2/). The code below will run into a CORS problem and won’t work. Read the new post to see the correct version.*
...
![Twine Javascript Screen Shot](https://i0.wp.com/johnastewart.org/wp-content/uploads/2017/10/Screen-Shot-2017-10-03-at-1.31.17-PM.png?resize=629%2C407&ssl=1)
